...
# python -u main.py --dataset animal --exp_name qwen_0727_stop_B100 --budget 100 --k 100 --rerank search --early_stop > logs/qwen_0727/animal_search_stop_B100.log
# python -u main.py --dataset chemical_compound --exp_name qwen_0727_stop_B100 --budget 100 --k 100 --rerank search --early_stop > logs/qwen_0727/chemical_search_stop_B100.log
# python -u main.py --dataset product --exp_name qwen_0727_stop_B100 --budget 100 --k 100 --rerank search --early_stop > logs/qwen_0727/product_search_stop_B100.log

python -u main.py --dataset animal --exp_name qwen_0727_stop_B200 --budget 200 --k 200 --rerank search --early_stop > logs/qwen_0727/animal_search_stop_B200.log
python -u main.py --dataset chemical_compound --exp_name qwen_0727_stop_B200 --budget 200 --k 200 --rerank search --early_stop > logs/qwen_0727/chemical_search_stop_B200.log
python -u main.py --dataset product --exp_name qwen_0727_stop_B200 --budget 200 --k 200 --rerank search --early_stop > logs/qwen_0727/product_search_stop_B200.log

python -u main.py --dataset animal --exp_name qwen_0727_stop_B500 --budget 500 --k 500 --rerank search --early_stop > logs/qwen_0727/animal_search_stop_B500.log
python -u main.py --dataset chemical_compound --exp_name qwen_0727_stop_B500 --budget 500 --k 500 --rerank search --early_stop > logs/qwen_0727/chemical_search_stop_B500.log
python -u main.py --dataset product --exp_name qwen_0727_stop_B500 --budget 500 --k 500 --rerank search --early_stop > logs/qwen_0727/product_search_stop_B500.log
